...
import "../staking/interfaces/IRewardTrackerMT.sol";
...
contract RewardReader {
    ...
    function getStakingInfoMT(address /*_account*/, address _rewardTracker) public view returns (address[] memory, uint256[] memory) {
        return IRewardTrackerMT(_rewardTracker).tokensPerIntervals();
    }
