...
contract RewardRouterV2 is IRewardRouterV2, ReentrancyGuard, Governable {
    ...
    address public glp; // MOX.sol.sol Liquidity Provider token
    ...
    // for MLP.sol.sol.sol transfers it is also possible to transfer MLP.sol.sol.sol into an account using the StakedGlp contract
    ...
    function _stakeBnGmx(address _account) private {
        ...
        // get the baseStakedAmount which would be the sum of staked mox and staked esGmx tokens
